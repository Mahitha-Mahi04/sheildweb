    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <aside className="w-64 bg-white shadow-md">
          ...
          {["Overview", "Users", "Scans", "Alerts", "Settings"].map((item) => (
            <Button
              ...
              className={`w-full justify-start px-4 py-2 ${
                activeTab === item.toLowerCase() ? "bg-primary/10 text-primary" : ""
              }`}
        ...
        <div className="absolute bottom-4 left-4">
          <Button onClick={() => handleLogOut()} variant="ghost" className="w-full justify-start px-4 py-2">
      ...
      <main className="flex-1 p-8 overflow-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            { title: "Threats Blocked", value: stats.threatsBlocked, icon: Shield },
            { title: "Pending Alerts", value: stats.pendingAlerts, icon: AlertTriangle },
          ].map((stat) => (
            <Card key={stat.title}>
