...
export default function Footer() {
  ...
  const submitFeedback = async () => {
    try {
      setMessage('');
      if(feedback.length < 5  || feedback.length > 30){
        setMessage("Feedback characters must be between 5 and 30");
      } 
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <Textarea onChange={(e: ChangeEvent<HTMLTextAreaElement>) => setFeedback(e.target.value)}/>
